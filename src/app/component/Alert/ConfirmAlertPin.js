...
import DataPajakLunasMain from '../DataPajakLunas/DataPajakLunasMain';

export default class ConfirmAlertPin extends Component {
    state = {
        open: false,
        callback: null
    }
    ...
    confirm =()=>{
        window.location = '/list_pajak_lunas';
    }
                                        ...
                                        <List>
                                            <Grid container spacing={3} style={{display:'flex',flexDirection:'row',alignItems:'center',justifyContent:'center'}}>
                                                <Grid item xs={4}>
                                                    ...
                                                    >
                                                        <Typography style={{height:'200%', transform: 'translateY(5%)'}}>Batal</Typography>
                                                    </Paper>
                                                </Grid>
                                                <Grid item xs={4}>
                                                <Paper onClick={this.confirm} style={{backgroundColor: Constant.primaryColor, textAlign:'center', color:'white', height:'30px'}}
                                                    >
                                                        <Typography style={{height:'200%', transform: 'translateY(5%)'}}>OK</Typography>
                                                    </Paper>
                                                </Grid>
                                            </Grid>
                                        </List>
