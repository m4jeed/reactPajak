...
import ConfirmAlertPin from '../Alert/ConfirmAlertPin';

function handleAlertPin() {
    //this.setState({ e.target.value })
};

export default function DataPajakBlList (props) { 
        ...
        <Fragment>
           <Card>
               <CardContent>
                    ...
                    <ConfirmAlertPin title="Masukan Pin Transaksi Anda">
                        {confirm =>(
                            <div style={{marginTop:20}}>
                                <Paper style={{padding:10, marginTop:5, marginBottom:5,
                                    ...
                                    onClick={confirm(handleAlertPin)}
                                    >
                                        Bayar
                                </Paper>
                            </div>
